...
@onready var perkLoad = preload("res://assets/menus/inputButton.tscn")
...
var activeTweens : Array[bool] = [false, false, false]
var tween : Tween
...
func update_health() -> void:
	...
	tween.connect("finished", reset_activeTweens_value.bind(0))
